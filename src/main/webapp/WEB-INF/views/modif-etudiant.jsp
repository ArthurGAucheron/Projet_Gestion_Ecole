...
<body>
	...
	<form:form modelAttribute="modifEtudiantAttribute" method="POST" action="${pageContext.request.contextPath}/etu/updateetu">
		<table>
			<tr>
	...
	<a href="${pageContext.request.contextPath}/admin/listeetu">Retour à la liste des étudiants</a>
