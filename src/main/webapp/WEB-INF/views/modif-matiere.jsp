...
<body class="d-flex flex-column h-100">
	...
	<div class=container-fluid style="padding-top: 100px;">
		...
		<a href="${pageContext.request.contextPath}/admin/listemat">Retour
			à la liste des matières</a> <br></br>

		<div class="container">
			<form:form modelAttribute="matiereModifCommand" method="POST"
				action="${pageContext.request.contextPath}/admin/updatemat">
				...
				<div class="row-form">
					<div class="form-group col-md-6">
						...
						<form:select path="enseignant.idPersonne">
							...
							<form:options items="${attributEnseignant}"
